...
func SetupDBWithFTS(db *gorm.DB) error {
	...
	if err := db.AutoMigrate(&NoteItem{}, &NoteTag{}, &NoteLink{}, &ChatSession{}, &ChatMessage{}, &PromptTemplate{}, &ShareLink{}, &WeixinBotCredential{}, &WeixinUserContext{}, &WeixinMessage{}, &NoteChunk{}, &NoteChunkEmbedding{}, &FileMetadata{}, &ImageTask{}, &ImageResult{}, &DailyReview{}, &CronTask{}, &CronTaskLog{}, &ExtractorRule{}, &SystemSetting{}, &WikiEntity{}, &WikiReference{}, &PendingWikiTask{}); err != nil {
